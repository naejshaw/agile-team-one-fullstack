...
isset($query) ? $query .= "SELECT * FROM categorias " : $query = "SELECT * FROM categorias ";
							               ...
							               <label>Visibilidade:</label>
											<div class="fake-select">
												...
												<select name="visible">
		                                            ...
		                                            <option value="<?php echo $numeric_data['visibilidade'][$x]['value']; ?>" <?php if( isset($_GET['visible']) && $_GET['visible'] == $numeric_data['visibilidade'][$x]['value'] ) { echo 'SELECTED'; }; ?>><?php echo $numeric_data['visibilidade'][$x]['name']; ?></option>
		                                            <?php } ?>
												</select>
												<div class="clear"></div>
											</div>
