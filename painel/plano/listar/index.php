...
<?php if( isset($_GET['msg']) && $_GET['msg'] == "bemvindo" ) { ?>
									...
									<div class="row">
										<div class="col-md-9">
											<div class="form-field-default">
												<input type="text" name="voucher" placeholder="Código do voucher" value="<?php echo htmlclean( isset($_GET['voucher']) ? $_GET['voucher'] : '' ); ?>"/>
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-field-default">
