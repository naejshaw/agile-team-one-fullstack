...
isset($query) ? $query .= "SELECT * FROM pedidos " : $query = "SELECT * FROM pedidos ";
							               ...
							               <label>Status:</label>
											<div class="fake-select">
												...
												<select name="status">
		                                            ...
		                                            <option value="<?php echo $numeric_data['status_pedido'][$x]['value']; ?>" <?php if( isset($_GET['status']) && $_GET['status'] == $numeric_data['status_pedido'][$x]['value'] ) { echo 'SELECTED'; }; ?>><?php echo $numeric_data['status_pedido'][$x]['name']; ?></option>
		                                            <?php } ?>
												</select>
											</div>
							              </div>
