...
isset($query) ? $query .= "SELECT * FROM produtos " : $query = "SELECT * FROM produtos ";
							               ...
							               <label>Categoria:</label>
					                        <div class="fake-select">
					                          ...
					                          <select id="input-categoria" name="categoria">
							                      ...
							                      <option <?php if( isset($_GET['categoria']) && $_GET['categoria'] == $quickdata['id'] ) { echo "SELECTED"; }; ?> value="<?php echo $quickdata['id']; ?>"><?php echo $quickdata['nome']; ?></option>
							               ...
							               <label>Visibilidade:</label>
											<div class="fake-select">
												...
												<select name="visible">
		                                            ...
		                                            <option value="<?php echo $numeric_data['status'][$x]['value']; ?>" <?php if( isset($_GET['visible']) && $_GET['visible'] == $numeric_data['status'][$x]['value'] ) { echo 'SELECTED'; }; ?>><?php echo $numeric_data['status'][$x]['name']; ?></option>
		                                            <?php } ?>
												</select>
												<div class="clear"></div>
											</div>
							               ...
							               <label>Status:</label>
											<div class="fake-select">
												...
												<select name="status">
													<option></option>
		                                            <?php for( $x = 0; $x < count( $numeric_data['status'] ); $x++ ) { ?>
		                                            <option value="<?php echo $numeric_data['status'][$x]['value']; ?>" <?php if( isset($_GET['status']) && $_GET['status'] == $numeric_data['status'][$x]['value'] ) { echo 'SELECTED'; }; ?>><?php echo $numeric_data['status'][$x]['name']; ?></option>
		                                            <?php } ?>
												</select>
												<div class="clear"></div>
											</div>
