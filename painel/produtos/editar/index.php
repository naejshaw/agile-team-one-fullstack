...
<?php
  ...
  if( $formdata ) {
    ...
    if( !$checkerrors ) {
      ...
      if( edit_produto( $id,$eid,$categoria,$destaque,$ref,$nome,$descricao,$valor,$oferta,$valor_promocional,$variacao,$status,$visible,$integrado ) ) {
      ...
      <form id="the_form" class="form-default" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <?php if( isset($checkerrors) && $checkerrors ) { list_errors(); } ?>
