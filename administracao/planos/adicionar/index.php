          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
              ...
              <div class="form-field-default">
                  ...
                  <input type="text" name="duracao_meses" placeholder="Duração (em meses)" value="<?php echo htmlclean( isset($_POST['duracao_meses']) ); ?>">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
              ...
              <div class="form-field-default">
                  ...
                  <input type="text" name="duracao_dias" placeholder="Duração (em dias)" value="<?php echo htmlclean( isset($_POST['duracao_dias']) ); ?>">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
              ...
              <div class="form-field-default">
                  ...
                  <input class="maskmoney" type="text" name="valor_total" placeholder="Valor total" value="<?php echo htmlclean( dinheiro( isset($_POST['valor_total']), "BR") ); ?>">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
              ...
              <div class="form-field-default">
                  ...
                  <input class="maskmoney" type="text" name="valor_mensal" placeholder="Valor mensal" value="<?php echo htmlclean( dinheiro( isset($_POST['valor_mensal']), "BR") ); ?>">
              ...
              <div class="form-field-default">
                  ...
                  <div class="radios">
                    ...
                    <div class="form-field-radio">
                      <input type="radio" name="funcionalidade_marketplace" value="1" <?php if( isset($_POST['funcionalidade_marketplace']) == 1 OR !isset($_POST['funcionalidade_marketplace']) ){ echo 'CHECKED'; }; ?>> Sim
                    </div>
                    <div class="form-field-radio">
                      <input type="radio" name="funcionalidade_marketplace" value="2" <?php if( isset($_POST['funcionalidade_marketplace']) == 2 ){ echo 'CHECKED'; }; ?>> Não
                    </div>
                    <div class="clear"></div>
                  </div>
            ...
            <div class="col-md-12">
              ...
              <div class="form-field-default">
                  ...
                  <div class="radios">
                    <div class="spacer"></div>
                    <div class="form-field-radio">
                      <input type="radio" name="funcionalidade_variacao" value="1" <?php if( isset($_POST['funcionalidade_variacao']) == 1 OR !isset($_POST['funcionalidade_variacao']) ){ echo 'CHECKED'; }; ?>> Sim
                    </div>
                    <div class="form-field-radio">
                      <input type="radio" name="funcionalidade_variacao" value="2" <?php if( isset($_POST['funcionalidade_variacao']) == 2 ){ echo 'CHECKED'; }; ?>> Não
                    </div>
                    <div class="clear"></div>
                  </div>
            ...
            <div class="col-md-12">
              ...
              <div class="form-field-default">
                  ...
                  <div class="radios">
                    <div class="spacer"></div>
                    <div class="form-field-radio">
                      <input type="radio" name="funcionalidade_banners" value="1" <?php if( isset($_POST['funcionalidade_banners']) == 1 OR !isset($_POST['funcionalidade_banners']) ){ echo 'CHECKED'; }; ?>> Sim
                    </div>
                    <div class="form-field-radio">
                      <input type="radio" name="funcionalidade_banners" value="2" <?php if( isset($_POST['funcionalidade_banners']) == 2 ){ echo 'CHECKED'; }; ?>> Não
                    </div>
                    <div class="clear"></div>
                  </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="form-field-default">
                  ...
                  <label>Ordem:</label>
                  <input type="text" name="ordem" placeholder="Ordem" value="<?php echo htmlclean( isset($_POST['ordem']) ); ?>">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="form-field-default">
                  ...
                  <input type="number" name="limite_produtos" placeholder="Limite de produtos" value="<?php if( isset($_POST['limite_produtos']) ) { echo htmlclean( isset($_POST['limite_produtos']) ); } else { echo '10'; } ?>">
