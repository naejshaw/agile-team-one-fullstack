          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="form-field-default">
                  ...
                  <input class="autocompleter <?php if( isset($data['estabelecimento']) && isset($data['estabelecimento_id']) ) { echo "autocomplete-selected"; } ?>" type="text" name="estabelecimento" placeholder="Estabelecimento" value="<?php echo htmlclean( data_info( "estabelecimentos",$data['rel_estabelecimentos_id'],"nome" ) ); ?>" completer_url="<?php just_url(); ?>/_core/_ajax/autocomplete_estabelecimentos.php" completer_field="estabelecimento_id">
