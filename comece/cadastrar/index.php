    ...
    if( !$checkerrors ) {
      ...
      if( new_estabelecimento( 
        ...
        if( make_login( $email,$pass,"login","1" ) ) {
          ...
          header("Location: ".get_just_url()."/painel/inicio/?msg=bemvindo");
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <div class="form-field-radio">
                          <input type="radio" name="pagamento_dinheiro" value="1" <?php if( isset($_POST['pagamento_dinheiro']) &&   $_POST['pagamento_dinheiro'] == 1 OR !isset($_POST['pagamento_dinheiro']) ){ echo 'CHECKED'; }; ?>> Sim
                        </div>
                        <div class="form-field-radio">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <div class="form-field-radio">
                          <input type="radio" name="pagamento_cartao_debito" value="1" element-show=".elemento-bandeiras-debito" <?php if( isset($_POST['pagamento_cartao_debito']) &&   $_POST['pagamento_cartao_debito'] == 1 OR !isset($_POST['pagamento_cartao_debito']) ){ echo 'CHECKED'; }; ?>> Sim
                        </div>
                        <div class="form-field-radio">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <div class="form-field-radio">
                          <input type="radio" name="pagamento_cartao_credito" value="1" element-show=".elemento-bandeiras-credito" <?php if(isset($_POST['pagamento_cartao_credito']) && $_POST['pagamento_cartao_credito'] == 1 OR !isset($_POST['pagamento_cartao_credito']) ){ echo 'CHECKED'; }; ?>> Sim
                        </div>
                        <div class="form-field-radio">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <div class="form-field-radio">
                          <input type="radio" name="pagamento_cartao_alimentacao" value="2" element-hide=".elemento-bandeiras-alimentacao" <?php if(isset($_POST['pagamento_cartao_alimentacao']) &&  $_POST['pagamento_cartao_alimentacao'] == 2 OR !isset($_POST['pagamento_cartao_alimentacao']) ){ echo 'CHECKED'; }; ?>> Não
                        </div>
                        <div class="clear"></div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <div class="form-field-radio">
                          <input type="radio" name="pagamento_outros" value="2" element-hide=".elemento-outraforma" <?php if(isset($_POST['pagamento_outros']) &&  $_POST['pagamento_outros'] == 2 OR !isset($_POST['pagamento_outros']) ){ echo 'CHECKED'; }; ?>> Não
                        </div>
                        <div class="clear"></div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <div class="form-field-radio">
                          <input type="radio" name="entrega_retirada" value="1" <?php if(isset($_POST['entrega_retirada']) &&  $_POST['entrega_retirada'] == 1 OR !isset($_POST['entrega_retirada']) ){ echo 'CHECKED'; }; ?>> Sim
                        </div>
                        <div class="form-field-radio">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <div class="form-field-radio">
                          <input type="radio" name="entrega_entrega" value="1" element-show=".elemento-frete" <?php if(isset($_POST['entrega_entrega']) &&  $_POST['entrega_entrega'] == 1 OR !isset($_POST['entrega_entrega']) ){ echo 'CHECKED'; }; ?>> Sim
                        </div>
                        <div class="form-field-radio">
                          <input type="radio" name="entrega_entrega" value="2" element-hide=".elemento-frete" <?php if(isset($_POST['entrega_entrega']) &&  $_POST['entrega_entrega'] == 2 ){ echo 'CHECKED'; }; ?>> Não
                        </div>
                        <div class="clear"></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-field-default">
                          ...
                          <div class="form-field-radio">
                            <input type="radio" name="entrega_entrega_tipo" value="1" element-show=".elemento-frete-valor" <?php if(isset($_POST['entrega_entrega_tipo']) &&  $_POST['entrega_entrega_tipo'] == 1 OR !isset($_POST['entrega_entrega_tipo']) ){ echo 'CHECKED'; }; ?>> Valor fixo
                          </div>
                          <div class="form-field-radio">
                            <input type="radio" name="entrega_entrega_tipo" value="2" element-hide=".elemento-frete-valor" <?php if(isset($_POST['entrega_entrega_tipo']) &&  $_POST['entrega_entrega_tipo'] == 2 ){ echo 'CHECKED'; }; ?>> Sob consulta
                          </div>
                          <div class="clear"></div>
