...
if (preg_match("/^([a-zA-Z0-9]+)$/", $token)) {
    ...
    if ($hastoken >= 1) {
        ...
        $verpedido = mysqli_query($db_con, "SELECT id, comprovante FROM pedidos WHERE rel_estabelecimentos_id = '$iduser' AND status = '4' AND data_hora LIKE '%$data_i%' ORDER BY id ASC LIMIT 1"); //STATUS é o numero do status do pedido que ele irá imprimir
