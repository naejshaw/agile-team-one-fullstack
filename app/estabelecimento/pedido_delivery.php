...
if ($formdata) {
	...
	// TODO: buscar public e secret keys do banco de dados
	$public_key = mysqli_real_escape_string($db_con, $_GET['public_key']);
	$secret_key = mysqli_real_escape_string($db_con, $_GET['secret_key']);
											...
											<div class="fake-select">
												...
												<select id="input-forma-entrega" name="forma_entrega">
													...
													?>
														...
														<option <?php if ($_SESSION['checkout']['forma_entrega'] == $quickdata['id']) {
																	echo 'SELECTED';
																}; ?> value="<?php echo $quickdata['id']; ?>"><?php echo htmlclean($quickdata['nome']); ?> <?php if ($quickdata['valor'] >= 0.01) {
																																																															echo "(+ R$ " . htmlclean(dinheiro($quickdata['valor'], "BR")) . ")";
																																																														}; ?></option>
